...
const faqs = [
  ...
  },
  {
    ...
    a: 'الأسعار لم تُعلن بعد. الوصول حالياً عبر تجربة موجّهة بعدد محدود من المكاتب، والمنضمون فيها يُبلَّغون بالأسعار أولاً قبل أي التزام.',
  },
  {
    q: 'كيف أنضم؟',
    a: 'اضغط «اطلب انضمامك» وراسلنا على info@qaydalaqar.com، وسنعود إليك لترتيب انضمام مكتبك إلى التجربة الموجّهة وتفعيل حسابك.',
  },
  {
