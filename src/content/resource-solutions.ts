  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'بدلاً من ملف يحتوي أرقاماً فقط، يصبح لكل عقد جدول استحقاقات، ولكل دفعة حالة، ولكل متأخر متابعة، ولكل مستند سياق داخل العقار أو العقد.',
          'هكذا يبقى الإكسل مفيداً كمرحلة أو مصدر استيراد، لكن التشغيل اليومي ينتقل إلى سجل حي يمكن للفريق متابعته وإغلاقه.',
        ],
      },
    ],
    checklist: [
    ...
    cta: {
      ...
      body: 'قيد العقار يساعدك على تحويل العقارات والعقود والتحصيل والمتابعات من جداول متفرقة إلى سجل تشغيلي واحد.',
      href: 'https://app.qaydalaqar.com/auth/signup',
      label: 'ابدأ تنظيم مكتبك',
    },
  },
  {
