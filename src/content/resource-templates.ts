...
export const publicResourceTemplates: ResourceTemplate[] = [
  ...
  {
    slug: 'excel-migration-audit-template',
    title: 'قالب تدقيق ملفات الإكسل قبل الانتقال إلى نظام',
    description:
      'قائمة عملية لتنظيف ملفات إكسل العقارات والتحصيل قبل نقلها إلى نظام تشغيل عقاري أو توحيدها داخل المكتب.',
    category: 'تشغيل المكتب',
    relatedTopicSlug: 'operations',
    updatedAt: '2026-07-02',
    readingTime: '٨ دقائق',
    audience: 'أصحاب المكاتب التي تعتمد على Excel أو Google Sheets',
    keywords: ['ملف إكسل عقاري', 'تنظيف بيانات العقارات', 'ترحيل بيانات الإكسل', 'بديل الإكسل'],
    summary:
      'استخدم هذا القالب قبل أي انتقال من الإكسل حتى لا تنقل الفوضى نفسها إلى النظام الجديد.',
    useWhen: [
      'عند وجود أكثر من ملف أو نسخة لإدارة العقارات والتحصيل.',
      'قبل إدخال العقود النشطة والمتأخرات في نظام جديد.',
      'عند توحيد عمل الفريق بعد فترة من الاعتماد على ملفات شخصية.',
    ],
    blocks: [
      {
        heading: 'جرد الملفات',
        rows: [
          'حدد كل الملفات المستخدمة حالياً: عقارات، عقود، تحصيل، مصروفات، تقارير، مستندات.',
          'اكتب مالك كل ملف: من يعدله؟ ومن يعتمد أرقامه؟',
          'حدد آخر تاريخ تحديث ظاهر لكل ملف.',
          'اختر ملفاً واحداً معتمداً لكل نوع، وضع بقية النسخ في أرشيف قراءة فقط.',
        ],
      },
      {
        heading: 'تنظيف الأعمدة',
        intro: 'الهدف ليس جعل الملف جميلاً، بل جعله قابلاً للفهم والترحيل.',
        rows: [
          'وحد صيغة التاريخ في كل الملفات.',
          'افصل اسم العقار عن رقم الوحدة إذا كانا في خلية واحدة.',
          'افصل المبلغ المستحق عن المبلغ المحصل والمتبقي.',
          'استخدم حالات محددة بدلاً من كلمات متعددة لنفس المعنى، مثل: نشط، منتهي، متأخر، محصل.',
          'احذف الأعمدة الزخرفية أو المكررة التي لا تخدم قراراً أو ترحيلاً.',
        ],
      },
      {
        heading: 'ربط السجلات',
        rows: [
          'ضع معرفاً بسيطاً لكل عقار أو وحدة.',
          'اربط كل عقد بالعقار أو الوحدة المناسبة.',
          'اربط كل دفعة بالعقد أو الاستحقاق الذي تخصه.',
          'اكتب مرجع المستند أو رابط الملف إذا كان العقد أو إثبات الدفع محفوظاً خارج الجدول.',
        ],
      },
      {
        heading: 'أولوية النقل',
        rows: [
          'ابدأ بالعقود النشطة لا الأرشيف القديم.',
          'انقل المتأخرات والمتابعات المفتوحة قبل البيانات التاريخية.',
          'انقل المستندات الحرجة: العقود، إثباتات الدفع، المراسلات المهمة.',
          'راجع أول تقرير تحصيل بعد النقل قبل إدخال بقية البيانات.',
        ],
      },
      {
        heading: 'اختبار ما بعد النقل',
        rows: [
          'هل يظهر إجمالي المستحقات مثل الملف المعتمد؟',
          'هل يظهر إجمالي المحصل والمتأخر دون فرق غير مفسر؟',
          'هل يمكن فتح سجل عقد والوصول إلى دفعاته ومستنداته؟',
          'هل يعرف الفريق أين يسجل متابعة جديدة بدلاً من إضافتها في ملف خارجي؟',
        ],
      },
    ],
    cautions: [
      'لا تنقل كل شيء دفعة واحدة إذا كانت الملفات غير نظيفة.',
      'لا تعتمد على لون الخلية كمعلومة؛ حوّله إلى حالة مكتوبة.',
      'لا ترحل الأرشيف القديم قبل ضبط العقود النشطة والمتأخرات الحالية.',
    ],
    relatedArticleSlugs: [
